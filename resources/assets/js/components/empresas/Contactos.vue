         ...
         <div class="modal fade bd-example-modal-lg" id=ModalNotas tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
             <div class="modal-dialog modal-lg" role="document">
                 <div class="modal-content">
                     ...
                     <div class="modal-body">
                         <textarea v-model="notaContacto" name="editor1" id="editor1" rows="15" cols="93"
        ...
        methods: {
            ...
            updatecontacto() {
                 axios.put('/contactosupdate/'+this.idContacto,{
                    ...
                    'empresa_id':this.empresacontacto,
                }, {
                headers: {Authorization: '123 456'}
                    ...
                    .catch(error => {
                        ...
                        if (error.response.data.errors.empresa_id) {
                            this.errors.push(error.response.data.errors.empresa_id[0]);
                        }
                    });
            },
            destroycontacto() {
                    ...
                    case "contacto": {
                        switch (action) {
                            ...
                            case 'update': {
                                ...
                                this.empresacontacto =data['empresa_id'];
                                this.errortitleContacto = 0;
                                $('#myModal').modal('show');
                                break;
                            }
