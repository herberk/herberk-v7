<div class="text-center">
    <button type="button" class="btn btn-outline-primary btn-sm"> <a href="<?php echo e(route('empresashownotas', [$empresas->id])); ?>">
            <i class="fas fa-tasks" style=color:#3729fa></i> Notas</a></button>
