<div id="showcase">
    <div class="container">
        <div class="row">
           <div class="col-12">
            <h1 class="text-center"><?php echo e(trans('message.screenshots')); ?></h1>
           </div>
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php echo e(asset('/img/item-01.png')); ?>" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo e(asset('/img/item-02.png')); ?>" alt="Secon slide">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo e(asset('/img/item-03.png')); ?>" alt="Tri slide">
                    </div>
                </div>
            </div>
        </div>
